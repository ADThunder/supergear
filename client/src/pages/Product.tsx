  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        //todo : check 2 trường hợp nếu có id thì lấy ra 1 sản phẩm nếu không có id thì lấy ra hết sản phẩm
        if (id) {
          setProductData(data);
          setAllProducts([]);
        } else {
          ...
          {!!id && productData && _.isEmpty(allProducts) ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="bg-[#f7f7f7f7] p-5 rounded-md flex flex-col items-center justify-center gap-2">
                  <img
                    src={productPayment}
                    alt="product payment"
